        ...
        if(rho==0):
            ...
            for theta in angle:
                ...
                if((x_1[0]==float(0)) & (y_1[0]==float(0))):
                    ...
                    if(filt=='sym'):
                        if((round(theta)==round(math.pi))|(round(theta)==2*round(math.pi))):
                            tuples[2,cnt]=rho
                            tuples[3,cnt]=theta-(math.pi/2)

                            cnt=cnt+1
                    else:
                         if((round(theta)==round(math.pi))):
                            tuples[2,cnt]=rho
                            tuples[3,cnt]=theta-(math.pi/2)
